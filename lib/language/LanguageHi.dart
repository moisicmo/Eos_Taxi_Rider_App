...
class LanguageHi extends BaseLanguage {
  ...
  @override
  String get theapplicationisnotuptodate => 'आवेदन अद्यतित नहीं है.';

  @override
  String get theapplicationisnotcurrent => 'एप्लिकेशन वर्तमान नहीं है. एप्लिकेशन का उपयोग करने के लिए आपको अपडेट करना होगा.';

  @override
  String get updateapp => 'ऐप अपडेट करें';

  @override
  String get cancelapp => 'रद्द करना';
  ...
  @override
  String get mostReliableEosRiderApp => 'सबसे विश्वसनीय शक्तिशाली राइडर ऐप';
